...
const translations = {
  ...
  te: {
    ...
    "greetings-parents-list": "<strong>శ్రీమతి &amp; శ్రీ దురిశెట్టి పద్మ-జనార్దన్</strong><br><strong>శ్రీమతి &amp; శ్రీ పాబ్బోజి శ్రీలత-రమేష్</strong>",
    ...
    "greetings-grandparents": "కీ||శే|| శ్రీమతి &amp; శ్రీ దురిశెట్టి రాంబాయి-మాన్యాండ్లు గార్ల దివ్య ఆశీస్సులతో...<br>కీ||శే|| శ్రీ పూసాల నర్సయ్య మాతృశ్రీ అమృత, భాగ్య గార్ల ఆశీస్సులతో...",
    "greetings-title": "చిరునవ్వుల పిలుపు",
    "greetings-harish": "మా సోదరుని పెళ్ళికి తప్పక రారండి... హార్థిక్, హేమంత్",
